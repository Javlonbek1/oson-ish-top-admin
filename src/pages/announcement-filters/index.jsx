...
// import { useNavigate, useParams, useSearchParams } from "react-router-dom"; // 🔥 qo‘shildi
...
//      // Status va filterlarni tiklash
//      setStatus(stored.status);
//      setSearchText(stored.searchText);
//      setSalaryFrom(stored.salaryFrom);
//      setSalaryTo(stored.salaryTo);
//      setAnnTypeId(stored.annTypeId);
//      setSearchTextDraft(stored.searchText);
//      setSalaryFromDraft(stored.salaryFrom);
//      setSalaryToDraft(stored.salaryTo);
//      setAnnTypeDraft(stored.annTypeId);

//      // URL’dagi page ni tiklash yoki 0 ga o‘rnatish
//    };
...
//                 setSearchParams(searchParams);
//               }}
//               className={`px-4 py-2 cursor-pointer rounded-t-lg font-medium transition whitespace-nowrap ${
//                 status === tab
//                   ? "bg-blue-500 text-white shadow"
//                   : "text-gray-600 hover:text-blue-500"
//               }`}
